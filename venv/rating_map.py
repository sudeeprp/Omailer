...
GROUP_ASSESSMENT_MAP = {
    ...
    'D: Goals unclear / impl.driven': '''The team implemented the minimum necessary functionality. In future, they could clarify the goals pro-actively and focus on the customer context.''',
    ...
    'C: Just made it work': '''The team did the minimum required to work on top of existing code.''',
    ...
    "D: Minimal or no automation": '''The team tested everything manually. In future, they could focus on automating the flows, followed by the checks and asserts.'''
}


INDIVIDUAL_ASSESSMENT_MAP = {
    '5': 'Excellent',
    '4': 'Good',
    '3': 'Acceptable',
    '2': 'Needs focus',
    'Absent': 'Did not attend mid-term assessment.',
    '1 2': 'Observed improvement during the program. Still needs focus.',
    '1 3': 'Significant improvement observed during the program. Acceptable.',
    '2 3': 'Observed improvement during the program. Acceptable.',
    '2 4': 'Significant improvement observed during the program. Good.',
    '3 4': 'Observed improvement during the program. Good.',
    '3 5': 'Significant improvement observed during the program. Excellent',
    '4 5': 'Observed improvement during the program. Excellent'
}
