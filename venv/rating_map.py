...
GROUP_ASSESSMENT_MAP = {
    ...
    'A: Multiple improvements done': '''The team made multiple improvements to the code they inherited, in areas of warnings, linting, complexity, duplication and readability.''',
    'B: At least one improvement': '''The team improved the code they received in terms of readability''',
